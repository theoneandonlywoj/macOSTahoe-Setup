...
This repo includes a Makefile for managing Doom Emacs and tmux. Run `make help` for a quick reference, or see [docs/makefile-commands.md](docs/makefile-commands.md) for full details.
